...
storiesOf("input-fee", module)
	...
	.add("Default", () => ({
		...
		template: `<div class="p-5 w-1/3"><input-fee></input-fee></div>`,
	}))
	.add("Range", () => ({
		component: InputFeeComponent,
		template: `<div class="p-5 w-1/3"><input-fee [isStatic]="false" [min]="10" [avg]="3000000" [max]="12345678"></input-fee></div>`,
	}));
