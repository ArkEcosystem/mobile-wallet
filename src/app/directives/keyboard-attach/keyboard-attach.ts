...
export class KeyboardAttachDirective implements OnInit, OnDestroy {
	...
	constructor(
		...
		setTimeout(() => {
			...
			this.initialPaddingBottom =
				parseInt(computedStyle["padding-bottom"]) || 0;
		}, 0);
	}
	...
	private setElementPosition(pixels: number) {
		this.elementRef.nativeElement.style.paddingBottom =
			pixels + this.initialPaddingBottom + "px";
		// this.content.resize();
	}
}
